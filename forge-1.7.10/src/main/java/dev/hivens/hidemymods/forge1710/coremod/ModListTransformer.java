package dev.hivens.hidemymods.forge1710.coremod;
 ...
 *
 * The whole body goes, including the leading super.toBytes call that
 * 1.7.10 has and 1.12.2 does not: FMLHandshakeMessage.toBytes is a bare
 * return on this version, verified against forge 10.13.4.1614, so
 * dropping it writes nothing different to the wire.
 *
 * The class name FMLHandshakeMessage$ModList is stable across the
 * 1.7.10 Forge builds the FML handshake has shipped under. FML and
...
public final class ModListTransformer implements IClassTransformer {
    ...
    private static final String SPOOF_INTERNAL =
        "dev/hivens/hidemymods/forge1710/coremod/ModListSpoof";
